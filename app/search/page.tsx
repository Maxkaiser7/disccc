                    ...
                    { data.data.events.length > 0 && data.data.events.map((event: any) => {
                        return (
                            <div className={"relative"}>
                                ...
                                <h2 className={"text-2xl absolute bottom-[0.75rem] bg-indigo-600 p-1 index-5"}>Evenement</h2>
                            </div>
                        )
                    })}
                    { data.data.artists.length > 0 && data.data.artists.map((artist: any) => {
                        return (
                            <div className={"relative"}>
                                ...
                                <h2 className={"text-2xl absolute bottom-[0] left-[9rem] bg-sky-600 p-1 index-5"}>Artiste</h2>
                            </div>
                        )
                    })}
                    { data.data.organisations.length > 0 && data.data.organisations.map((organisation: any) => {
                        return (
                            <div className={"relative"}>
                                ...
                                <h2 className={"text-2xl absolute bottom-[0.75rem] bg-orange-600 p-1 index-5"}>Evenement</h2>
                            </div>
                        )
                    })}
